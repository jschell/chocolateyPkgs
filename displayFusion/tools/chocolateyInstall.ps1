...
install-ChocolateyPackage -packageName 'displayFusion' -fileType 'exe' -silentArgs $silentOptions -url  'http://www.binaryfortress.com/Data/Download/?package=displayfusion'
